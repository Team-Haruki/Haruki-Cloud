...
func GameIDIsNil() predicate.Cardepisode {
	return predicate.Cardepisode(sql.FieldIsNull(FieldGameID))
}

// GameIDNotNil applies the NotNil predicate on the "game_id" field.
func GameIDNotNil() predicate.Cardepisode {
	return predicate.Cardepisode(sql.FieldNotNull(FieldGameID))
}
