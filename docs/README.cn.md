...
`POST /internal/pjsk/command` — Bot 发送文本指令，Cloud 返回渲染后的 PNG 图片。

```json
{ "im_platform": "qq", "im_user_id": "12345", "command": "/卡面 1001", "server": "jp" }
```

详见 [项目进展总结](project-status-summary.cn.md) 中的 API 端点一览。
...
| 日期 | 文档 | 变更 |
|------|------|------|
| 2026-03-23 | 项目进展总结 | v3.0：Bot 指令 API 完成，新增 API 端点一览 |
| 2026-03-23 | 项目进展总结 | v2.0：Parser 合并完成 |
| 2026-03-23 | README 索引 | 新增 Bot 指令 API 说明 |
| 2026-03-21 | Service-Test 合并状态 | 完成总结 |

---

**维护者**：Haruki-Cloud Team  
**最后更新**：2026-03-23 05:18 UTC
