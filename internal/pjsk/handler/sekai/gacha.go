...
func resolveGachaDetailOrList(ctx HarrukiSekaiHandlerContext) (*parser.ResolvedCommand, error) {
	...
	if params, ok, err := parseSingleGachaQuery(args); err != nil {
		...
		return makeResolvedCmdWithParams(ctx, parser.ModuleGacha, "gacha-detail", params), nil
	}
	...
	return makeResolvedCmdWithParams(ctx, parser.ModuleGacha, "gacha-list", params), nil
}
