...
func (_c *AliasCreate) SetAliasType(v string) *AliasCreate {
	_c.mutation.SetAliasType(v)
	return _c
}

// SetAliasTypeID sets the "alias_type_id" field.
func (_c *AliasCreate) SetAliasTypeID(v int) *AliasCreate {
	_c.mutation.SetAliasTypeID(v)
	return _c
}

// SetAlias sets the "alias" field.
func (_c *AliasCreate) SetAlias(v string) *AliasCreate {
	_c.mutation.SetAlias(v)
	return _c
}

// SetID sets the "id" field.
func (_c *AliasCreate) SetID(v int64) *AliasCreate {
	_c.mutation.SetID(v)
	return _c
}
...
func (_c *AliasCreate) check() error {
	if _, ok := _c.mutation.AliasType(); !ok {
		return &ValidationError{Name: "alias_type", err: errors.New(`pjsk: missing required field "Alias.alias_type"`)}
	}
	...
	if _, ok := _c.mutation.AliasTypeID(); !ok {
		return &ValidationError{Name: "alias_type_id", err: errors.New(`pjsk: missing required field "Alias.alias_type_id"`)}
	}
	if _, ok := _c.mutation.Alias(); !ok {
		return &ValidationError{Name: "alias", err: errors.New(`pjsk: missing required field "Alias.alias"`)}
	}
