...
func TestResolveRegionAssetPathFallsBackToOnDemand(t *testing.T) {
	...
	rel := filepath.Join("jp-assets", "ondemand", "gacha", "ab_gacha_1", "logo", "logo.png")
...
func TestResolveRegionAssetPathPrefersStartAppOverOnDemand(t *testing.T) {
	...
	startApp := filepath.Join(tmpDir, "jp-assets", "startapp", rel)
	...
	onDemand := filepath.Join(tmpDir, "jp-assets", "ondemand", rel)
