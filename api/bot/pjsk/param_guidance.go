...
var commandParameterGuidance = map[string]parameterGuidance{
	...
	"card/box":                    {"查卡箱参数", "使用角色、属性、稀有度、技能或帮助中列出的筛选条件"},
	"card/detail":                 {"卡牌详情参数", "使用卡牌 ID、角色名或可识别的卡牌条件"},
	"card/image":                  {"卡面参数", "使用卡牌 ID 或可识别的卡牌条件"},
	"card/list":                   {"卡牌列表参数", "使用角色、属性、稀有度、技能或帮助中列出的筛选条件"},
	...
	"music":                       {"歌曲查询参数", "使用歌曲 ID、歌曲名或别名，可追加难度"},
	...
	"music/note-count":            {"物量查询参数", "使用歌曲 ID、歌曲名或别名，可追加难度"},
	"music/progress":              {"歌曲进度参数", "使用支持的难度及 FC/AP 等筛选条件"},
	"music/rewards":               {"歌曲奖励参数", "使用歌曲 ID、歌曲名或别名，可追加难度"},
...
var parameterErrorPatterns = []parameterErrorPattern{
	...
	{prefix: "无法解析要比较的歌曲", parameter: "歌曲比较", expectation: "使用歌曲 ID、歌曲名或可识别的别名"},
	{prefix: "failed to resolve compare music selection", parameter: "歌曲比较", expectation: "使用歌曲 ID、歌曲名或可识别的别名"},
	{prefix: "unable to parse music query", parameter: "歌曲", expectation: "使用歌曲 ID、歌曲名或可识别的别名"},
	{prefix: "failed to resolve deck music selection", parameter: "歌曲", expectation: "使用歌曲 ID、歌曲名或可识别的别名，可追加支持的难度"},
	{prefix: "failed to resolve music meta query", parameter: "歌曲", expectation: "使用歌曲 ID、歌曲名或可识别的别名"},
	...
	{prefix: "failed to search card list", parameter: "卡牌筛选", expectation: "使用角色、属性、稀有度、技能或帮助中列出的筛选条件"},
	{prefix: "failed to search card box", parameter: "卡箱筛选", expectation: "使用角色、属性、稀有度、技能或帮助中列出的筛选条件"},
	{prefix: "failed to search card", parameter: "卡牌", expectation: "使用卡牌 ID、角色名或更明确的筛选条件"},
	{prefix: "card not found (filter)", parameter: "卡牌", expectation: "使用卡牌 ID、角色名或更明确的筛选条件"},
	...
	{prefix: "mysekai talk list invalid character query", parameter: "角色", expectation: "使用角色全名、常用别名或角色 ID"},
	{prefix: "mysekai fixture detail invalid query", parameter: "家具", expectation: "使用家具 ID、分类或名称关键词"},
	{prefix: "未识别到角色", parameter: "角色", expectation: "使用角色全名、常用别名或角色 ID"},
	{prefix: "未找到角色", parameter: "角色", expectation: "使用角色全名、常用别名或角色 ID"},
	{prefix: "匹配到多个角色", parameter: "角色", expectation: "使用更完整的角色名或明确的角色 ID"},
	{prefix: "未找到家具类别", parameter: "家具分类", expectation: "使用帮助中列出的家具分类或来源"},
	{prefix: "找不到特定的卡牌", parameter: "卡牌", expectation: "使用卡牌 ID、角色名或更明确的筛选条件"},
