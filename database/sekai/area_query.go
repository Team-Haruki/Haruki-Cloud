...
func (_q *AreaQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *AreaQuery) FirstIDX(ctx context.Context) int {
...
func (_q *AreaQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *AreaQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *AreaQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *AreaQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//
//	client.Area.Query().
//		GroupBy(area.FieldServerRegion).
