...
const (
	// Label holds the string label denoting the mysekaigate type in the database.
	Label = "mysekaigate"
	...
	// Table holds the table name of the mysekaigate in the database.
	Table = "mysekaigates"
)

// Columns holds all SQL columns for mysekaigate fields.
var Columns = []string{
	FieldID,
	FieldServerRegion,
	FieldGameID,
...
// OrderOption defines the ordering options for the Mysekaigate queries.
