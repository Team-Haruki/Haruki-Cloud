...
const (
	// Label holds the string label denoting the skillpracticeticket type in the database.
	Label = "skillpracticeticket"
	...
	// Table holds the table name of the skillpracticeticket in the database.
	Table = "skillpracticetickets"
)

// Columns holds all SQL columns for skillpracticeticket fields.
var Columns = []string{
	FieldID,
	FieldGameID,
	FieldName,
...
// OrderOption defines the ordering options for the Skillpracticeticket queries.
