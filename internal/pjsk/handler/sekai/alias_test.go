...
func TestCharacterAliasQueryHandleBuildsResolvedCommand(t *testing.T) {
...
func TestCharacterAliasDeleteHandleBuildsResolvedCommand(t *testing.T) {
...
func TestAliasPendingHandleBuildsResolvedCommand(t *testing.T) {
