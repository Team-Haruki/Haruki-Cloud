...
func (_d *CostDelete) Where(ps ...predicate.Cost) *CostDelete {
	_d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query and returns how many vertices were deleted.
func (_d *CostDelete) Exec(ctx context.Context) (int, error) {
	return withHooks(ctx, _d.sqlExec, _d.mutation, _d.hooks)
}

// ExecX is like Exec, but panics if an error occurs.
func (_d *CostDelete) ExecX(ctx context.Context) int {
	n, err := _d.Exec(ctx)
	if err != nil {
		panic(err)
	}
...
func (_d *CostDelete) sqlExec(ctx context.Context) (int, error) {
...
// Where appends a list predicates to the CostDelete builder.
func (_d *CostDeleteOne) Where(ps ...predicate.Cost) *CostDeleteOne {
	_d._d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query.
func (_d *CostDeleteOne) Exec(ctx context.Context) error {
...
// ExecX is like Exec, but panics if an error occurs.
func (_d *CostDeleteOne) ExecX(ctx context.Context) {
