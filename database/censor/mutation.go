...
const (
	...
	// Node types.
	TypeImageModCache = "ImageModCache"
	TypeNameLog       = "NameLog"
	TypeResult        = "Result"
	TypeShortBio      = "ShortBio"
)

// ImageModCacheMutation represents an operation that mutates the ImageModCache nodes in the graph.
type ImageModCacheMutation struct {
	config
	op                Op
	typ               string
	id                *int
	...
	oldValue          func(context.Context) (*ImageModCache, error)
	predicates        []predicate.ImageModCache
}

var _ ent.Mutation = (*ImageModCacheMutation)(nil)

// imagemodcacheOption allows management of the mutation configuration using functional options.
type imagemodcacheOption func(*ImageModCacheMutation)

// newImageModCacheMutation creates new mutation for the ImageModCache entity.
func newImageModCacheMutation(c config, op Op, opts ...imagemodcacheOption) *ImageModCacheMutation {
	m := &ImageModCacheMutation{
		config:        c,
		op:            op,
		typ:           TypeImageModCache,
...
// withImageModCacheID sets the ID field of the mutation.
func withImageModCacheID(id int) imagemodcacheOption {
	return func(m *ImageModCacheMutation) {
		var (
			err   error
			once  sync.Once
			value *ImageModCache
		)
		m.oldValue = func(ctx context.Context) (*ImageModCache, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().ImageModCache.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withImageModCache sets the old ImageModCache of the mutation.
func withImageModCache(node *ImageModCache) imagemodcacheOption {
	return func(m *ImageModCacheMutation) {
		m.oldValue = func(context.Context) (*ImageModCache, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
func (m ImageModCacheMutation) Client() *Client {
...
func (m ImageModCacheMutation) Tx() (*Tx, error) {
...
// operation is only accepted on creation of ImageModCache entities.
func (m *ImageModCacheMutation) SetID(id int) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *ImageModCacheMutation) ID() (id int, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
func (m *ImageModCacheMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
	...
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().ImageModCache.Query().Where(m.predicates...).IDs(ctx)
	default:
...
func (m *ImageModCacheMutation) SetURL(s string) {
	m.url = &s
}

// URL returns the value of the "url" field in the mutation.
func (m *ImageModCacheMutation) URL() (r string, exists bool) {
	v := m.url
	if v == nil {
		return
	}
...
// OldURL returns the old "url" field's value of the ImageModCache entity.
// If the ImageModCache object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ImageModCacheMutation) OldURL(ctx context.Context) (v string, err error) {
...
func (m *ImageModCacheMutation) ResetURL() {
	m.url = nil
}

// SetHarukiUserID sets the "haruki_user_id" field.
func (m *ImageModCacheMutation) SetHarukiUserID(i int) {
	m.haruki_user_id = &i
	m.addharuki_user_id = nil
}

// HarukiUserID returns the value of the "haruki_user_id" field in the mutation.
func (m *ImageModCacheMutation) HarukiUserID() (r int, exists bool) {
	v := m.haruki_user_id
	if v == nil {
		return
	}
...
// OldHarukiUserID returns the old "haruki_user_id" field's value of the ImageModCache entity.
// If the ImageModCache object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ImageModCacheMutation) OldHarukiUserID(ctx context.Context) (v *int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ImageModCacheMutation) AddHarukiUserID(i int) {
...
func (m *ImageModCacheMutation) AddedHarukiUserID() (r int, exists bool) {
...
func (m *ImageModCacheMutation) ClearHarukiUserID() {
	m.haruki_user_id = nil
	m.addharuki_user_id = nil
	m.clearedFields[imagemodcache.FieldHarukiUserID] = struct{}{}
}

// HarukiUserIDCleared returns if the "haruki_user_id" field was cleared in this mutation.
func (m *ImageModCacheMutation) HarukiUserIDCleared() bool {
	_, ok := m.clearedFields[imagemodcache.FieldHarukiUserID]
	return ok
}

// ResetHarukiUserID resets all changes to the "haruki_user_id" field.
func (m *ImageModCacheMutation) ResetHarukiUserID() {
	m.haruki_user_id = nil
	m.addharuki_user_id = nil
	delete(m.clearedFields, imagemodcache.FieldHarukiUserID)
}

// SetResult sets the "result" field.
func (m *ImageModCacheMutation) SetResult(s string) {
	m.result = &s
}

// Result returns the value of the "result" field in the mutation.
func (m *ImageModCacheMutation) Result() (r string, exists bool) {
	v := m.result
	if v == nil {
		return
	}
...
// OldResult returns the old "result" field's value of the ImageModCache entity.
// If the ImageModCache object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ImageModCacheMutation) OldResult(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ImageModCacheMutation) ResetResult() {
	m.result = nil
}

// SetCreatedAt sets the "created_at" field.
func (m *ImageModCacheMutation) SetCreatedAt(t time.Time) {
	m.created_at = &t
}

// CreatedAt returns the value of the "created_at" field in the mutation.
func (m *ImageModCacheMutation) CreatedAt() (r time.Time, exists bool) {
	v := m.created_at
	if v == nil {
		return
	}
...
// OldCreatedAt returns the old "created_at" field's value of the ImageModCache entity.
// If the ImageModCache object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ImageModCacheMutation) OldCreatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ImageModCacheMutation) ResetCreatedAt() {
	m.created_at = nil
}

// Where appends a list predicates to the ImageModCacheMutation builder.
func (m *ImageModCacheMutation) Where(ps ...predicate.ImageModCache) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the ImageModCacheMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *ImageModCacheMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.ImageModCache, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
func (m *ImageModCacheMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *ImageModCacheMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (ImageModCache).
func (m *ImageModCacheMutation) Type() string {
	return m.typ
}
...
// AddedFields().
func (m *ImageModCacheMutation) Fields() []string {
	fields := make([]string, 0, 4)
	if m.url != nil {
		fields = append(fields, imagemodcache.FieldURL)
	}
	if m.haruki_user_id != nil {
		fields = append(fields, imagemodcache.FieldHarukiUserID)
	}
	if m.result != nil {
		fields = append(fields, imagemodcache.FieldResult)
	}
	if m.created_at != nil {
		fields = append(fields, imagemodcache.FieldCreatedAt)
	}
	return fields
}
...
// schema.
func (m *ImageModCacheMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// database failed.
func (m *ImageModCacheMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case imagemodcache.FieldURL:
		return m.OldURL(ctx)
	case imagemodcache.FieldHarukiUserID:
	...
	return nil, fmt.Errorf("unknown ImageModCache field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *ImageModCacheMutation) SetField(name string, value ent.Value) error {
	switch name {
	case imagemodcache.FieldURL:
		v, ok := value.(string)
		if !ok {
	...
	return fmt.Errorf("unknown ImageModCache field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *ImageModCacheMutation) AddedFields() []string {
	var fields []string
	if m.addharuki_user_id != nil {
		fields = append(fields, imagemodcache.FieldHarukiUserID)
	}
...
func (m *ImageModCacheMutation) AddedField(name string) (ent.Value, bool) {
	switch name {
	case imagemodcache.FieldHarukiUserID:
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *ImageModCacheMutation) AddField(name string, value ent.Value) error {
	switch name {
	case imagemodcache.FieldHarukiUserID:
		v, ok := value.(int)
		if !ok {
	...
	return fmt.Errorf("unknown ImageModCache numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *ImageModCacheMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(imagemodcache.FieldHarukiUserID) {
		fields = append(fields, imagemodcache.FieldHarukiUserID)
	}
	return fields
}
...
func (m *ImageModCacheMutation) FieldCleared(name string) bool {
...
func (m *ImageModCacheMutation) ClearField(name string) error {
	switch name {
	case imagemodcache.FieldHarukiUserID:
		m.ClearHarukiUserID()
		return nil
	}
	return fmt.Errorf("unknown ImageModCache nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *ImageModCacheMutation) ResetField(name string) error {
	switch name {
	case imagemodcache.FieldURL:
		m.ResetURL()
		return nil
...
func (m *ImageModCacheMutation) AddedEdges() []string {
...
func (m *ImageModCacheMutation) AddedIDs(name string) []ent.Value {
	return nil
}

// RemovedEdges returns all edge names that were removed in this mutation.
func (m *ImageModCacheMutation) RemovedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
func (m *ImageModCacheMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *ImageModCacheMutation) ClearedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
func (m *ImageModCacheMutation) EdgeCleared(name string) bool {
	return false
}

// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *ImageModCacheMutation) ClearEdge(name string) error {
	return fmt.Errorf("unknown ImageModCache unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *ImageModCacheMutation) ResetEdge(name string) error {
	return fmt.Errorf("unknown ImageModCache edge %s", name)
}
