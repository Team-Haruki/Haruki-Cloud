...
const (
	// Label holds the string label denoting the mysekaicharactertalkconditiongroup type in the database.
...
// OrderOption defines the ordering options for the Mysekaicharactertalkconditiongroup queries.
