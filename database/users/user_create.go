...
func (_c *UserCreate) SetPjskBannedGameAccountBindAttempts(v int) *UserCreate {
...
func (_c *UserCreate) SetNillablePjskBannedGameAccountBindAttempts(v *int) *UserCreate {
	if v != nil {
		_c.SetPjskBannedGameAccountBindAttempts(*v)
	}
	return _c
}
