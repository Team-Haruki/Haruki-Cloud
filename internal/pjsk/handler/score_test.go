...
func TestScoreControlHandleBuildsCommandRequest(t *testing.T) {
...
func TestMusicMetaHandleBuildsCommandRequest(t *testing.T) {
...
func TestCustomRoomScoreControlHandleBuildsCommandRequest(t *testing.T) {
...
func TestMusicBoardHandleBuildsCommandRequest(t *testing.T) {
...
func TestMusicBoardHandleAcceptsCompareAliasCommand(t *testing.T) {
	h := sekaiHandlers{}.MusicBoardHandle()
