...
const (
	// Label holds the string label denoting the imagemodcache type in the database.
	Label = "image_mod_cache"
	...
	// Table holds the table name of the imagemodcache in the database.
	Table = "image_mod_cache"
)

// Columns holds all SQL columns for imagemodcache fields.
var Columns = []string{
	FieldID,
	FieldURL,
	FieldHarukiUserID,
...
// OrderOption defines the ordering options for the ImageModCache queries.
